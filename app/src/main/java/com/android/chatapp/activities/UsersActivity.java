...
import com.android.chatapp.adapters.UsersAdapter;
import com.android.chatapp.databinding.ActivityUsersBinding;
import com.android.chatapp.listeners.UserListener;
    ...
    private void getUsers() {
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    loading(false);
                    String currentUserId = preferenceManager.getKey(Constants.KEY_USER_ID);
